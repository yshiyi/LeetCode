...
**Method:**\
1. Create an extra array/vector to hold the result.
2. Reverse array/vector three times. The 1st time, reverse the whole array/vector. The 2nd time, reverse the first k elements. The 3rd time, reverse the rest of elements.
