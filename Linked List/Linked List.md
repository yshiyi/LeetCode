...
* [Leetcode Linked List](#Leetcode-Linded-List)
    ...
    * [11. Partition list](#11-Partition-List)
       * [86M. Partition List](#86M-Partition-List)
<!-- GFM-TOC -->
...
[Python](https://github.com/yshiyi/LeetCode/blob/main/Linked%20List/86M.%20Partition%20List.py)
```
