...
"""
Method: Use BFS to traverse the graph.
        Need a dictionary and a set.
        Use the set to check if we have visited the same node.
        Use the dictionary to record the copy of the node.
        Time complexity: O(N)
