...
Method: Binary Search
        For example, [2, 3, 4]
        Let's convert the list to [2, 2+3, 2+3+4] = [2, 5, 9] -> [1,2,  3,4,5,  6,7,8,9]
        Then we randomly pick a value between 1 and 9. 
        Use binary search to search for the first element that is equal to or greater than that value from [2, 5, 9].
        In other words:
        2 >= 1, 2
        5 >= 3, 4, 5
        9 >= 6, 7, 8, 9
        This is the probability to pick each element in the original list.
"""
